...
This is an example of Rmarkdown document that you could use as starting point or as a template for future projects, we tried to use mostly all the commands we explained during the session. You can download the file [here](./Sessions/Session1.Rmd) and the [Cheat Sheet](https://www.rstudio.com/wp-content/uploads/2016/03/rmarkdown-cheatsheet-2.0.pdf). For further reading, this is an amaizing source [Rmarkdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/).
